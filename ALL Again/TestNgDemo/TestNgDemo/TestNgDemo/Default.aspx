...
<body>
    ...
    <div ng-app="myApp" ng-controller="myCntrl">
        <table>
            <tr>
                ...
                <td>
                    ...
                    <input type="text" id="txtStudentName" data-ng-model="student.StudentName" />
                </td>
            </tr>
            <tr>
                <td colspan="2" align="center">
                    ...
                    <input type="button" value="Update" ng-click="updateStudent()" ng-show="notshow" />
                </td>
            </tr>
        </table>
        <br />
        ...
        <table>
            ...
            <tr ng-repeat="student in StudentList | orderBy">
                ...
                <td>
                    ...
                    <a href="#" ng-click="getStudentById(student.StudentID)">Edit</a>
                </td>
            </tr>
        </table>
    </div>
