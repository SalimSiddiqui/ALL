<%@ Page Language="C#" MasterPageFile="~/admin/AdminMaster.master" AutoEventWireup="true"
    CodeFile="WhatsNew.aspx.cs" Inherits="admin_WhatsNew" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="content" style="width:100%">
        <div class="pin" style="width:100%;background:#fff" >
                ...
                <asp:GridView ID="GridView1" runat="server" CssClass="table" EnableModelValidation="True"
                    ...
                    <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                        ...
                        <asp:TemplateField HeaderText="Title">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="Label2" runat="server" Text='<%# Bind("New_Title") %>'></asp:Label>
                            </ItemTemplate>
                            <HeaderStyle CssClass="tr" />
